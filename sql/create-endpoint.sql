...
CREATE CERTIFICATE AGCertificate2021_2121 FROM FILE ='/dbatools-setup/AGCertificate2021_2121.cer' WITH PRIVATE KEY(FILE='/dbatools-setup/AGCertificate2021_2121.pvk', DECRYPTION BY PASSWORD='dbatools.IO')
GO
